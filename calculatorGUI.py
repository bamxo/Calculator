...
# date: March 3, 2023
# file: calculatorGUI.py a Python file that defines a calculator graphical user interface
# input: users can press buttons to simulate a calculator
# output: selected numbers, operators, and calculations are shown on the window
